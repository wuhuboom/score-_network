layui
  ...
  .define(['conf', 'view', 'api', 'jquery', 'siam'], function(exports) {
    ...
    self.on('savePassword', function(e) {
      self.navigate('/admin/password')
    })
    self.on('info', function(e) {
      self.navigate('/admin/info')
    })
    self.on('bind', function(e) {
      self.navigate('/admin/bind')
    })
