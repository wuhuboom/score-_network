...
class IpQuery
{
    ...
    private $last;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      // 最后一条索引
    private $total;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     // 索引总数
    private $dbFile    = EASYSWOOLE_ROOT . '/public/qqwry.dat';                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            // 纯真 IP 数据库文件存放路径
    ...
    public function query($ip)
    {
        ...
        foreach ($location as $k => $v) {
            ...
            $location[$k] = iconv('gbk', 'utf-8', $v);
            $location[$k] = preg_replace(array(
                '/^.*CZ88\.NET.*$/isU',
                '/^.*纯真.*$/isU',
                '/^.*日IP数据/'
            ), '', $location[$k]);
    ...
    //获取省市运营商
    public function getAddress($address,$isp=''){
