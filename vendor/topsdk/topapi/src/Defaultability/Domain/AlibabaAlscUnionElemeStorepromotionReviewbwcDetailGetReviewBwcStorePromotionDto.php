...
class AlibabaAlscUnionElemeStorepromotionReviewbwcDetailGetReviewBwcStorePromotionDto {
    ...
    public function getLink() : AlibabaAlscUnionElemeStorepromotionReviewbwcDetailGetPromotionLink{
        return $this->link;
    }

    public function setLink(AlibabaAlscUnionElemeStorepromotionReviewbwcDetailGetPromotionLink $link){
        $this->link = $link;
    }
