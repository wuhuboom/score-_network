...
class AlibabaAlscUnionKbBbtItemStoreDetailGetStoreBusiness {
    ...
    public function getBusinessTime() : AlibabaAlscUnionKbBbtItemStoreDetailGetStoreBusinessTime{
        return $this->business_time;
    }

    public function setBusinessTime(AlibabaAlscUnionKbBbtItemStoreDetailGetStoreBusinessTime $businessTime){
