...
class AlibabaAlscUnionKbBbtItemDetailGetBbtItemDetailDto {
    ...
    public function getItemDetail() : AlibabaAlscUnionKbBbtItemDetailGetItemDetail{
        return $this->item_detail;
    }

    public function setItemDetail(AlibabaAlscUnionKbBbtItemDetailGetItemDetail $itemDetail){
    ...
    public function getBrand() : AlibabaAlscUnionKbBbtItemDetailGetBrand{
        return $this->brand;
    }

    public function setBrand(AlibabaAlscUnionKbBbtItemDetailGetBrand $brand){
        $this->brand = $brand;
    }
    ...
    public function getPurchaseLimit() : AlibabaAlscUnionKbBbtItemDetailGetPurchaseLimit{
        return $this->purchase_limit;
    }

    public function setPurchaseLimit(AlibabaAlscUnionKbBbtItemDetailGetPurchaseLimit $purchaseLimit){
