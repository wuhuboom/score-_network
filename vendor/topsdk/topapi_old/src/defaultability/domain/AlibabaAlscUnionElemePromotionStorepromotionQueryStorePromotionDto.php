...
class AlibabaAlscUnionElemePromotionStorepromotionQueryStorePromotionDto {
    ...
    public function getOverlayCoupon() : AlibabaAlscUnionElemePromotionStorepromotionQueryOverlayCouponDTO{
        return $this->overlay_coupon;
    }

    public function setOverlayCoupon(AlibabaAlscUnionElemePromotionStorepromotionQueryOverlayCouponDTO $overlayCoupon){
