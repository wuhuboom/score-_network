...
(function () {
    ...
    **/
    ...
    console.log(http+window.location.host+"/UEditor")
    /**
    ...
    **/
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: http+window.location.host+"/UEditor" //URL + php/controller.php
        ...
        , toolbars: [[
            'source', '|','autotypeset', 'undo', 'redo','|', 'fontsize', '|','fontfamily','|', 'blockquote', 'horizontal', '|', 'removeformat', 'formatmatch', 'cleardoc', '|', 'link', 'unlink', 'emotion',
        ...
        , initialContent: '在这里直接输入或者粘贴内容'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
